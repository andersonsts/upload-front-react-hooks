...
const FileProvider = ({ children }: { children: any }) => {
  ...
  // atualiza o estado que armazena os files...
  ...
  // processa cada arquivo que ta sendo enviado pelo usuario
  const processUpload = useCallback(
    (uploadedFile: IFile) => {
      ...
      .then(response => {
        console.log(
          `A imagem ${uploadedFile.name} ja foi enviada para o servidor!`
        )
  ...
  // lida com os arquivos que foram recebidos pelo dropzone
